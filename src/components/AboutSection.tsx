        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div className="animate-slide-up delay-200">
              ...
              When I moved to Canada, I joined <a href="https://monstersaliensrobotszombies.com/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Marz VFX</a> as a Computer Vision Engineer, where I spearheaded the patent submission and production deployment of an automatic de-aging pipeline. This technology was successfully applied to projects such as Zoe’s Playlist and Turner & Hooch, enabling automated blemish correction on lead actors in post-production.
